...
export default function AboutPage() {
  ...
  return (
    /* 1. Added the base fade-in-up class to the outer layout wrapper */
    <div className="flex gap-12 items-start max-w-6xl mx-auto pt-10 pb-20 fade-in-up">

      {/* Left Side: Sidebar Icon (Animates first at 100ms) */}
      ...
      {/* Right Side: Content Card (Animates slightly later at 300ms) */}
