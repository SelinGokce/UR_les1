...
export default function ProjectPage() {
  ...
  const [formData, setFormData] = useState({
    title: 'Birds-Eye',
    description: 'Birds-Eye is een app voor natuurdagboeken en fotografie die je ook helpt bij het vinden van verschillende soorten fauna en flora in jouw omgeving.',
