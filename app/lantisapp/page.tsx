...
export default function ProjectPage() {
  ...
  const [formData, setFormData] = useState({
    title: 'Redux Lantis',
    description: 'Redux-Lantis is een locatiegebaseerd spel dat op een leuke en boeiende manier het belang van de Oosterweelverbinding in Antwerpen laat zien.',
    tools: 'HTML, CSS, JS, Server, groepswerk'
  })
        ...
        <div className="bg-white/40 p-6 rounded-lg">
          <div className="flex flex-row gap-4">
            <div className="flex-1">
              <a href="/birdseye/mockupbirdseye.png" target="_blank" rel="noopener noreferrer" className="cursor-pointer hover:scale-110 transition-transform inline-block">
                <Image
                  src="/birdseye/mockupbirdseye.png"
                  alt="birds eye app mockup"
                  width={200}
                  height={200}
