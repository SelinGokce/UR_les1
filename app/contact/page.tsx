        ...
        <div className="relative min-h-screen">
            <div className="flex gap-12 items-start max-w-6xl mx-auto pt-10 pb-20 fade-in-up">
                ...
                <div className="flex flex-col items-center gap-3 mt-10 opacity-0 [animation-delay:100ms] animate-[fadeInUp_0.8s_ease-out_forwards]">
                    ...
                    <span className="text-white text-2xl font-bold tracking-tight">Contact</span>
                </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-3 max-w-sm">
                                    <h3 className="text-sm uppercase tracking-widest text-white/60 font-bold">Direct Mail</h3>
                                ...
                                {isEditingEmail ? (
                                    <form onSubmit={handleUpdatePrimaryEmail} className="flex gap-2 max-w-md font-mono">
                                        <input
                                            type="email"
                                            value={emailInput}
                                            onChange={(e) => setEmailInput(e.target.value)}
                                            className="bg-white/10 border border-white/20 rounded-full px-4 py-2 text-white text-sm focus:outline-none flex-1"
                                            required
                                        />
                                        <button
                                            type="submit"
                                            className="bg-white text-[#000752] font-bold px-4 py-2 rounded-full text-xs hover:bg-white/90"
                                        >
                                            Save
                                        </button>
                                        <button
                                            ...
                                            className="bg-white/10 text-white px-3 py-2 rounded-full text-xs hover:bg-white/20"
                                        >
                                            Cancel
                                        </button>
                                    </form>
                                    ...
                                    <div className="space-y-3">
                                        {emailList.map((item, idx) => (
                                            <a
                                                ...
                                                className="flex items-center justify-start gap-4 w-full max-w-sm py-3.5 px-8 rounded-full bg-gradient-to-b from-white/25 to-white/10 border border-white/35 shadow-lg backdrop-blur-md hover:bg-white/30 hover:border-white/50 transition-all duration-300 group"
                                            >
                            ...
                            {/* Current Status */}
                            <div>
                                <h3 className="text-sm uppercase tracking-widest text-white/60 font-bold mb-2">Current Status</h3>
                            ...
                            <div>
                                <h3 className="text-sm uppercase tracking-widest text-white/60 font-bold mb-4">Platforms & Socials</h3>
                                <div className="flex flex-col sm:flex-row flex-wrap gap-4 w-full">
                                    {contactLinks.map((item, index) => (
                                        <a
                                            ...
                                            className="flex items-center justify-start gap-4 py-3.5 px-8 rounded-full bg-gradient-to-b from-white/25 to-white/10 border border-white/35 shadow-lg backdrop-blur-md hover:bg-white/30 hover:border-white/50 transition-all duration-300 group min-w-[200px]"
                                        >
                                            <div className="relative w-[20px] h-[20px] shrink-0">
                                                <Image
                                                    src="/star-button.svg"
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-[300] flex items-center justify-center bg-black/60 backdrop-blur-md">
                    <div className="bg-[#000752] border border-white/20 p-8 rounded-[2rem] w-full max-w-md shadow-2xl mx-4 animate-fade-in">
                        <h2 className="text-2xl font-bold text-white mb-4 font-mono">Add Contact Entry</h2>
                        ...
                        <form onSubmit={handleSaveContact} className="space-y-4 font-mono">
                            {modalTab === 'link' ? (
                                <>
                                    <div>
                                        <label className="block text-xs uppercase tracking-wider text-white/60 mb-2">Platform Name</label>
                                        <input
                                            type="text"
                                            value={newPlatform}
                                    ...
                                    <div>
                                        <label className="block text-xs uppercase tracking-wider text-white/60 mb-2">URL / Link</label>
                                        <input
                                            type="text"
                                            value={newLink}
                                ...
                                <>
                                    <div>
                                        <label className="block text-xs uppercase tracking-wider text-white/60 mb-2">Email Label</label>
                                        <input
                                            type="text"
                                            value={newEmailLabel}
